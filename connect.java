...
public class connect {
	...
	public connect()
	{
		try
		{
			Class.forName("com.mysql.cj.jdbc.Driver");//This is our driver class.
			//In the above line of code, we are registering JDBC driver in our program.
			
			c=DriverManager.getConnection("jdbc:mysql://localhost:3306/project","root","Dhawal@6903");  //Here "project" is the name of the database and "root" is the username with no password.
